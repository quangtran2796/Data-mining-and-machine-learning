...
def cross_val_dt_rt(load_fun) -> (dict, dict):
    ...
    #Voi bai tap nay chi don gian la lay du lieu cho cay nhung thuat toan khac nhau
    #Do la thuat toan giua Desision Tree binh thuong va Radom Forest roi so sanh ket qua thoi
...
def main():
    # Get the data loader
    # Chua hieu cau truc cu phap lap trinh o day -> tim hieu them khi co thoi gian.
